...
namespace WebApplication1.ADMIN
{
    public partial class pageQUANLYDANHMUC : System.Web.UI.Page
    {
        ...
        protected void grvDANHMUC_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        protected void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            pr[0] = new SqlParameter("@TENDANHMUC", txtTenDanhMuc.Text);
            pr[1] = new SqlParameter("@MADANHMUC", txtMaDanhMuc.Text);
            int k = xulydulieu.ExeCute("pUPDATEDanhMuc", pr);
            LoadDanhMuc();
        }
    }
}